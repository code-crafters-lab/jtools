 ...
 */
public interface ASMTransformer extends ITransformer {

    @Override
    default byte[] getCode(byte[] sourceBytes, int order) {
        ...
        ClassVisitor classVisitor = Optional.ofNullable(this.getClassVisitor(classWriter)).orElse(classWriter);
